...
**The schema lives on the registry** as `__verified_pubsub_fields__/2`, generated by
...
recompiled after a registry change.
...
| Invalid field type in the registry | `Spark.Error.DslError` from `ValidateFields` |
